...
runTest( 'getById hit: ', 5000, file.getById( 3 ) );
runTest( 'getById miss: ', 6000, file.getById( '3' ) );
runTest( 'getLastId: ', 7000, file.getLastId() );
/*
...
runTest( 'deleteById miss: ', 8000, file.deleteById( 500 ) );
runTest( 'deleteById hit: ', 9000, file.deleteById( 3 ) );
runTest( 'deleteById hit; reviwing changes to the Array: ', 10000, file.getAll() );
